...
public interface IGroupService
{
    ...
    Task<GroupMessagesResponse> GetMessagesAsync(Guid userId, Guid groupId, int limit = 50, DateTimeOffset? before = null, CancellationToken cancellationToken = default);
